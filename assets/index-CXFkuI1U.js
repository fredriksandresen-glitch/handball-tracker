...
function SimpleApp() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: 20, background: "#1a1f3a", color: "white", minHeight: "100vh" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "🏐 Handball Tracker" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "React fungerer!" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Hvis du ser dette, er problemet i routing eller data." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => alert("Det fungerer!"), children: "Klikk meg" })
  ] });
}
ReactDOM.createRoot(document.getElementById("root")).render(/* @__PURE__ */ jsxRuntimeExports.jsx(SimpleApp, {}));
