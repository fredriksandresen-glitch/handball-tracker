import { c as createLucideIcon, u as useNavigate, r as reactExports, F as FeedEventType, P as Position, j as jsxRuntimeExports, a as cn, b as useActor, d as useQuery, e as createActor, L as Link, S as Search, f as SkeletonCard, U as Users } from "./index-CPElKy7J.js";
import { g as getNationalTeamInfo } from "./nationalTeamPlayers-DQ_sXgLF.js";
import { g as getCountdown, f as formatMatchDate } from "./handballService-Dfxy0dAn.js";
import { r as resolveImageUrl } from "./clawdbotPlayerProfile-CiM1Xaxo.js";
import { P as PositionBadge, a as POSITION_LABELS } from "./PositionBadge-CSTguUIW.js";
import { m as motion } from "./proxy-ZHkh6Rkm.js";
import { u as useFollowedPlayers, a as useUnfollowPlayer } from "./useFollowedPlayers-BHB52LVt.js";
import { u as usePlayerMatchStatsBatch } from "./usePlayer-Cl8t9O8f.js";
...
function Sparkline({ values }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "MEP-form siste kamper" }),
...
function PlayerImageFallback({ name }) {
...
function FeedPlayerCard({
  ...
  const mepMatches = matchStats.filter((match) => typeof match.mep === "number").sort((a, b) => getMatchDate(a).localeCompare(getMatchDate(b))).slice(-5);
  ...
  const latestGoals = keeper ? void 0 : (latestMatch == null ? void 0 : latestMatch.goals) ?? (lastGoalEvent == null ? void 0 : lastGoalEvent.statValue);
  const latestSaves = keeper ? latestMatch == null ? void 0 : latestMatch.saves : void 0;
  const latestSavePct = keeper ? latestMatch == null ? void 0 : latestMatch.savePct : void 0;
  ...
  const bgClass = (nationalTeam == null ? void 0 : nationalTeam.countryCode) === "FI" ? "bg-white" : placeholderBg(teamName);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.button,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("relative w-full aspect-[3/4.45] sm:aspect-[3/4]", bgClass), children: [
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx(PlayerImageFallback, { name: player.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 z-20 bg-gradient-to-t from-black/95 via-black/30 to-transparent" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-0 left-0 right-0 z-30 px-3.5 sm:px-3 pb-3.5 sm:pb-3 pt-12 sm:pt-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-black text-white text-[15px] sm:text-sm leading-tight truncate drop-shadow-sm", children: player.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] sm:text-[10px] text-white/65 truncate mt-0.5 font-body", children: teamName }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between mt-2.5 sm:mt-2 pt-2.5 sm:pt-2 border-t border-white/15", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
              (latestMatch == null ? void 0 : latestMatch.mep) !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block font-display font-black text-2xl sm:text-xl text-white leading-none tabular-nums", children: formatDecimal(latestMatch.mep) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-[8px] uppercase tracking-wide text-white/55 mt-0.5", children: "MEP sist" })
              ] }),
              latestSaves !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block font-display font-bold text-base text-white/85 leading-none tabular-nums", children: latestSaves.toString() }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-[8px] uppercase tracking-wide text-white/55 mt-0.5", children: "Redn." })
              ] }),
              latestSavePct !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "block font-display font-bold text-base text-white/85 leading-none tabular-nums", children: [
                  latestSavePct.toFixed(1),
                  "%"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-[8px] uppercase tracking-wide text-white/55 mt-0.5", children: "Red%" })
              ] }),
              latestGoals !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block font-display font-bold text-base text-white/85 leading-none tabular-nums", children: latestGoals.toString() }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-[8px] uppercase tracking-wide text-white/55 mt-0.5", children: "Mål" })
              ] }),
            ...
            sparkValues.length >= 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end gap-0.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px] uppercase tracking-wide text-white/45", children: "MEP-form" })
            ] })
          ] }),
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 sm:p-3 grid grid-cols-2 gap-2 sm:gap-3", "data-ocid": "feed-skeleton", children: [
