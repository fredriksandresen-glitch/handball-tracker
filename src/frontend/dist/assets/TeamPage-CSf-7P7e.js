import { c as createLucideIcon, M as MatchStatus, j as jsxRuntimeExports, H as House, a as cn, g as useParams, u as useNavigate, r as reactExports, P as Position, i as Skeleton, L as Link, T as Trophy, U as Users } from "./index-CPElKy7J.js";
...
import { u as useFollowedPlayers, c as useFollowPlayer, b as useIsFollowing, a as useUnfollowPlayer } from "./useFollowedPlayers-BHB52LVt.js";
import { c as usePlayerMatchStats } from "./usePlayer-Cl8t9O8f.js";
import { u as useTeam, b as usePlayersByTeam, c as useNextMatchForTeam, A as ArrowLeft, a as ArrowRight } from "./useTeam-BRpB6huA.js";
...
function RosterPlayerCard({
  ...
  const lastGoals = !keeper && lastStat ? Number((lastStat == null ? void 0 : lastStat.goals) ?? 0) : null;
  const lastSaves = keeper && lastStat ? Number((lastStat == null ? void 0 : lastStat.saves) ?? 0) : null;
  const lastSavePct = keeper && lastStat ? lastStat.savePct : void 0;
    ...
    Link,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full aspect-[3/4] rounded-2xl overflow-hidden bg-muted", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-0 left-0 right-0 px-3 pb-3 pt-10", children: [
          ...
          (lastGoals !== null || lastSaves !== null || lastMins !== null && lastMins > 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-2 pt-2 border-t border-white/15", children: [
            keeper && lastSaves !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("font-display font-black text-base leading-none", lastSaves > 0 ? "text-primary" : "text-white/50"), children: lastSaves }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-white/50 uppercase tracking-wide mt-0.5", children: "Redn." })
            ] }),
            keeper && lastSavePct !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-bold text-sm leading-none text-white/80", children: [
                lastSavePct.toFixed(1),
                "%"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-white/50 uppercase tracking-wide mt-0.5", children: "Red%" })
            ] }),
            !keeper && lastGoals !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("font-display font-black text-base leading-none", lastGoals > 0 ? "text-primary" : "text-white/50"), children: lastGoals }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-white/50 uppercase tracking-wide mt-0.5", children: "Mål" })
            ] }),
            !keeper && lastMins !== null && lastMins > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
