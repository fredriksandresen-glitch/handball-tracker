...
> = {
  [CURRENT_SEASON_ID]: {
    ...
    [FIRST_DIVISION_LEAGUE_ID]: ["Aker Topphåndball", "Kjelsås", "Volda", "Levanger", "Åsane", "Trondheim", "Gjøvik", "HK Rygge", "Stavanger", "Bækkelaget", "Haslum", "Fyllingen", "Byåsen Rekrutt", "Storhamar Rekrutt"],
  },
  [ARCHIVE_SEASON_ID]: {
    [ELITE_LEAGUE_ID]: [
      "Sola",
