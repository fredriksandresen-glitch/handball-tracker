    ...
    <div className="space-y-5" data-ocid="teams-page">
      ...
      {isLoading ? (
        ...
        <section className="rounded-2xl border border-border bg-card overflow-hidden">
          ...
          {standings.map((standing, index) => (
            <StandingRow key={standing.primeTeamId} standing={standing} team={teamByName.get(normalizeName(standing.name))} index={index} season={seasonId} league={leagueId} totalTeams={standings.length} />
          ))}
